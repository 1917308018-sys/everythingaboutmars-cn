// Based on React Bits — ScrollStack (MIT + Commons Clause)
// Adapted from the Lenis-driven implementation to native window scroll,
// so it stays consistent with the rest of the page's scrolling.
